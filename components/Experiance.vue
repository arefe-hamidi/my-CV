<template>
  <b-card>
    ...
    <b-card-text>
      <div v-for="(work, index) in works" :key="index" class="mt-3">
        ...
        <div
          class="achievement mt-2"
          v-for="(achievement, achIndex) in work.achievements"
          :key="achIndex"
        >
          <img
      ...
      works: [
        {
          ...
          achievements: [
            "Architected and developed a modern Customer Dashboard using <strong>Next.js 15</strong> and <strong>React 19</strong>, implementing a <strong>fractal modular architecture</strong> that combines modularity with repeatable patterns across scales for improved maintainability and scalability.",
            "Implemented enterprise-grade authentication using <strong>NextAuth.js</strong> integrated with <strong>Azure AD B2C</strong> and role-based access control, ensuring secure user sessions and comprehensive authorization management.",
            "Designed and implemented a unified data access layer using <strong>TanStack Query</strong> and <strong>proxyFetch</strong>, creating a centralized API access pattern that optimizes data fetching, caching, and synchronization across the application.",
            "Built a comprehensive internationalization (i18n) system with multi-language support, implementing locale-aware navigation and centralized route management to deliver seamless multilingual user experiences.",
            "Developed a flexible theme system supporting dark and light modes using <strong>Shadcn UI primitives</strong> and design tokens, ensuring consistent UI/UX patterns across the application.",
            "Established robust error handling mechanisms with unified error processing and user feedback systems, improving application reliability and user experience during error scenarios.",
            "Implemented server-side API calls and proxy fetch strategies for secure data fetching, optimizing SSR performance and enhancing application security by handling sensitive requests on the server.",
            "Developed comprehensive unit test suites using <strong>Vitest</strong> and <strong>React Testing Library</strong> with path alias support and mocking patterns, ensuring robust code quality and reducing regression bugs through automated testing strategies.",
            "Configured and maintained CI/CD pipelines using <strong>Microsoft Azure DevOps</strong> with Docker containerization, streamlining deployment processes and ensuring consistent production environments.",
          ],
        },
        {
          jobPosition: "Senior Front-End Developer",
        ...
        },
        {
          ...
          companyName: "Startup - Sharif University",
        ...
        {
          jobPosition: "Team Leader - Front-End Development",
